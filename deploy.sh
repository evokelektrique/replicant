#! /bin/bash
# Slightly modified version of "https://gist.github.com/BFTrick/3767319"

# main config
PLUGINSLUG="replicant"
CURRENTDIR=`pwd`
MAINFILE="replicant.php"
...
SVNURL="http://plugins.svn.wordpress.org/replicant/"
SVNUSER="evokelektrique" # your svn username
